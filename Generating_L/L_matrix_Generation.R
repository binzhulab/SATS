...
L_matrix_generation <- function(genomic_information, Types = c("COSMIC", "signeR")){
...
L_matrix_generation(Panel_1, Types = "COSMIC")
## Part of the results:
#         UHN-48-V1
# A[C>A]A  0.001487
# A[C>A]C  0.001120
...
L_matrix_generation(Panel_1, Types = "signeR")
#         UHN-48-V1
# C>A:ACA  0.001487
# C>A:ACC  0.001120
# C>A:ACG  0.000426
